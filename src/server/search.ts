      ...
      .where(
        and(
          ...
          or(
            ...
            ilike(client.namePhys, pattern),
            ilike(client.email, pattern),
            ilike(client.phone, pattern),
            sql`${client.aliases}::text ILIKE ${pattern}`,
          ),
        ),
      )
      ...
      .where(
        and(
          ...
          or(
            ...
            ilike(contact.nameNative, pattern),
            ilike(contact.email, pattern),
            ilike(contact.phone, pattern),
            sql`${contact.aliases}::text ILIKE ${pattern}`,
          ),
        ),
      )
    ...
    db
      ...
      .where(
        and(
          ...
          or(ilike(deal.name, pattern), ilike(deal.description, pattern)),
        ),
      )
    ...
    db
      ...
      .where(
        and(
          ...
          or(ilike(order.description, pattern), ilike(client.name, pattern)),
        ),
      )
